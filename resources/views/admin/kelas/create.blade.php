...
<ul class="admin-breadcrumb">
  ...
  <li><span class="sep">/</span></li>
  <li class="active">Tambah Kelas Baru</li>
</ul>
...
<div class="page-header">
  <div class="page-header-left">
    ...
    <p>Buat ruang kelas dan jenjang pendidikan baru yang akan tersedia untuk pendaftaran siswa.</p>
  </div>
  ...
  <div class="col-lg-6">
    <div class="card">
      <div class="card-header-custom">
        <h5><i class="mdi mdi-school-outline text-primary me-2"></i>Formulir Data Kelas</h5>
      </div>
        ...
        <form action="{{ route('admin.kelas.store') }}" method="POST">
          ...
          <div class="mb-4">
            ...
            <small style="color: var(--text-secondary); font-size: 0.75rem; margin-top: 4px; display: block;">
              Gunakan format yang konsisten, misalnya: Kelas 1-A, Kelas 2-B, dsb.
            </small>
          </div>
          ...
          <div class="mb-5">
            ...
            <select class="form-control @error('jenjang') is-invalid @enderror"
              ...
              <option value="RA"  {{ old('jenjang') == 'RA'  ? 'selected' : '' }}>RA — Raudhatul Athfal</option>
              <option value="MI"  {{ old('jenjang') == 'MI'  ? 'selected' : '' }}>MI — Madrasah Ibtidaiyah</option>
              <option value="MTs" {{ old('jenjang') == 'MTs' ? 'selected' : '' }}>MTs — Madrasah Tsanawiyah</option>
              <option value="MA"  {{ old('jenjang') == 'MA'  ? 'selected' : '' }}>MA — Madrasah Aliyah</option>
            </select>
            @error('jenjang')
              <div class="invalid-feedback">{{ $message }}</div>
            @enderror
          ...
          <div class="d-flex gap-2">
            <button type="submit" class="btn btn-primary">
              <i class="mdi mdi-check me-1"></i> Simpan Kelas
            </button>
